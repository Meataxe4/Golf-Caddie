...
const styles: Record<string, React.CSSProperties> = {
  container: {
    minHeight: '100vh',
    background: 'linear-gradient(180deg, #0d1f17 0%, #1a1a2e 50%, #0d1f17 100%)',
    display: 'flex',
    alignItems: 'center',
  ...
  tagline: { fontSize: 14, color: '#5a7a65', marginTop: 4 },
  ...
  stepHint: { fontSize: 13, color: '#5a7a65', marginBottom: 20, marginTop: -8 },
  nameInput: {
    width: '100%', padding: '16px 18px', borderRadius: 12,
    border: '2px solid #1e4d2b', background: '#132e1f', color: '#f1f5f9',
  ...
  presetCard: {
    ...
    border: '2px solid #132e1f', background: '#132e1f',
  ...
  presetRange: { fontSize: 12, color: '#5a7a65', fontWeight: 600 },
  presetDesc: { fontSize: 12, color: '#8faa97' },
  distanceInputGroup: { marginBottom: 16 },
  distLabel: { display: 'block', fontSize: 13, fontWeight: 600, color: '#8faa97', marginBottom: 6 },
  ...
  distUnit: { fontSize: 14, color: '#5a7a65', fontWeight: 600, width: 30 },
  shapeSection: { marginTop: 20 },
  shapeRow: { display: 'flex', gap: 8 },
  shapeBtn: {
    flex: 1, padding: '10px', borderRadius: 10,
    border: '2px solid #1e4d2b', background: 'transparent',
    color: '#8faa97', fontSize: 14, fontWeight: 600, cursor: 'pointer',
  ...
  backBtn: {
    padding: '14px 24px', borderRadius: 12, border: '1px solid #1e4d2b',
    background: 'transparent', color: '#8faa97', fontSize: 15, fontWeight: 600, cursor: 'pointer',
  },
  nextBtn: {
    flex: 1, padding: '14px', borderRadius: 12, border: 'none',
    background: 'linear-gradient(135deg, #22c55e 0%, #16a34a 100%)',
    color: '#0d1f17', fontSize: 16, fontWeight: 800, cursor: 'pointer',
  },
  startBtn: {
  ...
  dot: { width: 8, height: 8, borderRadius: 4, background: '#1e4d2b' },
